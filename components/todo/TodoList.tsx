      ...
      {role === 'teacher' && (
        <div className="flex gap-2 mb-5">
          <input
            ...
            className="flex-1 bg-white border border-kh-border rounded-full px-4 py-2.5 text-sm font-medium text-kh-dark placeholder:text-[#B0BCBA] outline-none focus:border-kh-teal transition-colors"
          />
          <button
            onClick={addTodo}
