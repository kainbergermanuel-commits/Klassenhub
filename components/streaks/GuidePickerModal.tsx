    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mt-5">
          ...
          <button onClick={confirm} disabled={pending} className="flex-1 py-3 rounded-full gradient-teal text-white text-sm font-bold hover:opacity-90 transition-opacity disabled:opacity-40">
            Übernehmen
          </button>
        </div>
