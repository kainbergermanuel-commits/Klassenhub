...
export default function HomeworkList({ homework, role, userId, classId, subtitle }: Props) {
  const [showModal, setShowModal] = useState(false)

  const today = todayLocalISO()
  const open = homework.filter(h => h.due_date >= today).sort((a, b) => a.due_date.localeCompare(b.due_date))
