...
import { createStudent } from '@/app/actions/userManagement'
...
export default function NeuerSchuelerPage() {
  ...
  if (result) {
    return (
      <div className="max-w-md">
        <div className="mb-6">
          <h1 className="text-[25px] font-extrabold text-kh-dark tracking-tight">Schüler:in angelegt</h1>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => router.push('/klasse')}
            className="flex-1 bg-white border border-kh-border text-kh-dark font-bold rounded-xl py-3 text-sm hover:bg-kh-page transition"
          >
            Zur Klasse
          </button>
        </div>
  ...
  return (
    <div className="max-w-md">
      ...
      <h1 className="text-[25px] font-extrabold text-kh-dark tracking-tight mb-1">Schüler:in anlegen</h1>
