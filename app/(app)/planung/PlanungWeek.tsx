...
export default function PlanungWeek({ weekStart, prevWeek, nextWeek, currentWeek, weekLabel, initialNotes }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[264px_1fr] gap-4 items-start">
      ...
      <div className="bg-gradient-to-br from-white via-white to-kh-teal-light rounded-2xl shadow-[0_8px_30px_rgba(20,40,45,.12)] p-4 md:sticky md:top-4">
      ...
      <div className="rounded-2xl shadow-[0_8px_30px_rgba(20,40,45,.12)] p-6 max-md:p-5 min-h-[420px] bg-gradient-to-br from-white via-white to-kh-page">
        <div className="flex items-start justify-between gap-3 mb-5">
          <div>
            ...
            <p className="text-[13px] text-kh-muted font-medium flex items-center gap-1.5">
              {selDateLabel}
              {isToday(selDate) && (
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-bold text-white bg-gradient-to-br from-[#1E5FA8] to-[#3FA9F5]">Heute</span>
              )}
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button onClick={() => setPickerOpen(o => !o)}
                ...
                <span className="text-[18px] leading-none font-medium -translate-y-px">+</span>Fach
              </button>
              {pickerOpen && (
