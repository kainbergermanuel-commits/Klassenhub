 ...
 *  eine Zeile, was es im Schulalltag konkret heißt, und ein Beispiel, das
...
export interface FocusInfo {
  ...
  story: string
  /** Was es im Schulalltag heißt. Ein Satz. */
  meaning: string
...
export const QUEST_FOCUS_INFO: Record<QuestFocusTag, FocusInfo> = {
  puenktlichkeit: {
    ...
    meaning: 'Pünktlich zu sein heißt nicht, schnell zu sein. Es heißt, dass die anderen mit dir rechnen können.',
  ...
  ausdauer: {
    ...
    meaning: 'Ausdauer heißt, dranzubleiben, wenn es gerade nicht spannend ist. Viele kleine Male schlagen ein großes Mal.',
  ...
  verantwortung: {
    ...
    meaning: 'Verantwortung heißt, deinen Teil zu machen, auch wenn niemand hinschaut und niemand nachfragt.',
    example: 'Den Dienst der Woche erledigen, ohne dass jemand erinnern muss.',
  },
  zusammenhalt: {
    title: 'Zusammenhalt bedeutet …',
    icon: 'diversity_3',
    story: 'Ein einzelner Faden reißt, wenn du daran ziehst. Dreißig Fäden nebeneinander sind ein Seil, das ein Boot hält. Kein Faden ist stärker geworden, sie liegen nur zusammen.',
    meaning: 'Zusammenhalt heißt, dass es der Klasse besser geht, wenn jeder ab und zu auf jemand anderen schaut.',
    example: 'Jemandem eine Aufgabe erklären, die du selbst schon verstanden hast.',
  },
  aufmerksamkeit: {
    title: 'Aufmerksamkeit bedeutet …',
    icon: 'visibility',
    story: 'Zwei gehen denselben Weg zur Schule. Der eine kommt an und weiß nichts. Der andere hat gesehen, dass beim Nachbarhaus ein Zettel hängt: der Hund wird vermisst. Am Nachmittag findet er ihn beim Bach.',
    meaning: 'Aufmerksamkeit heißt, etwas zu bemerken, bevor dich jemand darauf stößt. Man braucht dafür keine besonderen Augen, nur den Blick, der kurz hängen bleibt.',
